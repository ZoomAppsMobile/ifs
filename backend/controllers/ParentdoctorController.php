...
use backend\models\search\ParentdoctorSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\web\UploadedFile;
class ParentdoctorController extends BackendController
{
    ...
    {
        $searchModel = new ParentdoctorSearch();
    ...
    {
        if (($model = Parentdoctor::findOne($id)) !== null) {
            return $model;
        }
