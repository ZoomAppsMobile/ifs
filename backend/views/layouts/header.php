        ...
        <div class="navbar-custom-menu">
            ...
            <select class="language-button selectpicker" onchange="location = this.options[this.selectedIndex].value;">
                <? foreach (Yii::$app->view->params['country'] as $v):?>
                    <option <?=(Yii::$app->session["country"]==$v->id)?'selected':''?> value="/admin/lang/set-country?country=<?=$v->id?>"><?=$v->name?></option>
                <? endforeach;?>
            </select>

            <? $lang = \common\models\Countrylang::find()->where('country_id='.Yii::$app->session["country"])->all();?>
            <select class="language-button selectpicker" onchange="location = this.options[this.selectedIndex].value;">
                <? foreach ($lang as $v):?>
                    <option <?=(Yii::$app->session["lang"]==$v->id)?'selected':''?> value="/admin/lang/set-lang?lang=<?=$v->language_id?>"><?=$v->langName?></option>
                <? endforeach;?>
            </select>
